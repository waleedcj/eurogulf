...
export default function HomePage() {
  const services = [
    {
      image:
        "https://cdn.jsdelivr.net/gh/waleedcj/eurogulfassets/RRS.webp",
      title: "Refrigeration Systems",
      description:
        "Discover our Civil Defense Approved refrigeration solutions with a 99.9% uptime guarantee.",
      link: "/services#refrigeration",
      buttonText: "View Refrigeration",
    },
    {
      image:
        "https://cdn.jsdelivr.net/gh/waleedcj/eurogulfassets/coldroom.webp",
      title: "Cold Storage Installation",
      description:
        "Explore our complete turnkey cold storage solutions, from -40°C to +15°C.",
      link: "/services#cold-room",
      buttonText: "View Cold Storage",
    },
    {
      image:
        "https://cdn.jsdelivr.net/gh/waleedcj/eurogulfassets/freezer.webp",
      title: "Chiller & Freezer Services",
      description:
        "Learn about our advanced chiller and freezer services for industrial and commercial applications.",
      link: "/services#kitchen-hood",
      buttonText: "View Hood Systems",
    },
  ];
  ...
  const industries = [
    ...
    },
    {
      ...
      title: "Logistics",
      desc: "Cold Storage & Distribution",
    },
    {
  ...
  const brands = [
    ...
    },
    {
      name: "Foodstuff",
      image:
        "https://cdn.jsdelivr.net/gh/waleedcj/eurogulfassets/foodstuff.webp",
    },
    {
      name: "Glorex",
    ...
    },
    {
      name: "Master Baker",
      image:
        "https://cdn.jsdelivr.net/gh/waleedcj/eurogulfassets/masterBakernew.webp",
    },
    {
      name: "NAFFCO",
      image:
    ...
    },
    {
      name: "All Fresh Co",
      image:
        "https://cdn.jsdelivr.net/gh/waleedcj/eurogulfassets/allfreshco.webp",
    },
    {
      name: "Barakat",
  ...
  const differentiators = [
    {
      ...
      description:
        "All systems certified and compliant with UAE safety regulations",
    ...
    },
    {
      ...
      description:
        "Certified engineers with 10+ years specialized HVAC experience",
    ...
    },
    {
      ...
      description:
        "Rapid response team available round-the-clock for critical failures",
    ...
    },
    {
      ...
      description:
        "Advanced systems designed to reduce energy consumption by up to 30%",
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <div className="text-blue-200 text-sm">
                  Fully compliant with UAE standards
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="text-3xl font-bold text-yellow-400 mb-2">
        ...
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Over 500+ companies across the UAE trust Euro Gulf Tech for their
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  <div className="text-blue-900 mb-3 flex justify-center">
                    {stat.icon}
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Specialized HVAC solutions tailored for diverse industry
              requirements
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive services designed to meet the highest standards of
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              We don&apos;t just install systems – we deliver comprehensive
            ...
            {differentiators.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="bg-yellow-600 p-4 rounded-2xl flex-shrink-0">
                    {item.icon}
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-8 leading-relaxed opacity-90">
              Join 500+ satisfied clients who trust Euro Gulf Tech for their
              HVAC needs. Get a comprehensive assessment and custom quote within
              24 hours.
            </p>
